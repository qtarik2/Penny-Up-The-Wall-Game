...
[CustomEditor(typeof(PlayerWeapon3rdPerson))] 
public class PlayerWeapon3rdPersonEditor : Editor 
{
	public override void OnInspectorGUI () 
	{
		PlayerWeapon3rdPerson self = (PlayerWeapon3rdPerson)target;
		...
		//self.PlayerObject = (Transform)EditorGUILayout.ObjectField ("Player Object", self.PlayerObject, typeof(Transform), true);
		//EditorGUILayout.HelpBox("The Player Object is used as a reference point of where the raycast will be cast to calculate a hit. This can be the character model, parent, etc.", MessageType.None, true);
		//EditorGUILayout.Space();
